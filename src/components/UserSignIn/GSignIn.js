   ...
   */
    onSignInPress = async () => {
        try {
            ...
            const loggedInUser = JSON.stringify(firebaseUserCredential.user.toJSON());
            this.setState({
                loggedInUser,
                isUserSignedIn: true,
                isSigninInProgress: false
            });
            AsyncStorage.setItem('user', loggedInUser).then(result => {
    ...
    getCurrentUserInfo = async () => {
        try {
            ...
            console.log(`User details ${JSON.stringify(loggedInUser.user)}`);
        } catch (error) {
            this.setState({ loggedInUser: {} });
        }
    };
